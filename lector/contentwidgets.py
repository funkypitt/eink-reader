...
class PliantQTextBrowser(QtWidgets.QTextBrowser):
    def __init__(self, main_window, parent=None):
        ...
        # Available modes:
        # singlePage - default (optimized for eInk)
        # doublePage
        self.text_mode = 'singlePage'
    ...
    def generate_textbrowser_context_menu(self, position):
        ...
        singlePageAction = doublePageAction = 'We know the rules, you and I'
        annotationActions = []
...
class PliantWidgetsCommonFunctions:
    ...
    def change_chapter(self, direction, was_button_pressed=None, skip_refresh=False):
